...
workers.validateCheckData = function(originalCheckData){
  ...
  originalCheckData.userPhone = typeof(originalCheckData.userPhone)=='string'  && originalCheckData.id.trim().length ==10 ? originalCheckData.id : false;
...
workers.checkOutcome = function(originalCheckData,checkOutcome){
  ...
  var state = !checkOutcome.error && checkOutcome.responseCode && originalCheckData.indexOf(checkOutcome.responseCode)>-1? 'up' :'down';
